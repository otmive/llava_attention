...
img_path = 'helmet_right_of_chair.jpeg'
print(f"Image Path: {img_path}")

processor, model = load_model("internvl")
full_img_path = "clevr/images/CLEVR_blue_sphere_brown_cube_001137.png"
...
plotter.get_outputs("Answer in one word only. Which object is on the left? answer with 'helmet' or 'chair'")
print("ran get_outputs")
plotter.plot_bbox_on_attention_map(save_path="clevr_bbox_map.png")
print("plotted bbox on attention map")
plotter.plot_bbox_on_image(save_path="clevr_bbox_image.png")
print("plotted bbox on image")
plotter.plot_attention_through_layers(save_path="clevr_attention_layers.png", ylimit=0.008)
