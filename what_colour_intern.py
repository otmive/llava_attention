...
#             ha='center', va='bottom'
#         )
#     plt.savefig('accuracy_by_position_intern.png')
...
#             ha='center', va='bottom'
#         )
#     plt.savefig('accuracy_by_colour_intern.png')
...
if __name__ == "__main__":
    ...
    position_acc = [np.mean(acc_by_position[pos]) for pos in position_names]
    plt.figure(figsize=(8, 5))
    plt.bar(position_names, position_acc, color=['blue', 'orange'])
    plt.xlabel('Position')
    plt.ylabel('Average Accuracy')
    plt.title('Average Accuracy by Position')
    plt.ylim(0, 1)
    ...
    colour_acc = [np.mean(acc_by_colour[col]) for col in colour_names]
    plt.figure(figsize=(8, 5))
    plt.bar(colour_names, colour_acc, color=['red', 'blue', 'green', 'gold'])
    plt.xlabel('Colour')
    plt.ylabel('Average Accuracy')
    plt.title('Average Accuracy by Colour')
    plt.ylim(0, 1)
